...
from eeg_music.eegnet import TSCeptionConfig, ATCNetConfig
...
def create_config(
  ...
  config = EmotionEEGNetTrainingConfig(
    ...
    # data_path = Path("./bcmi_combined_18ch"),
...
all_configs = [
  ...
  create_config(
    model_config=ATCNetConfig(tcn_depth=2, F1=8, num_windows=6, D=1),
